...
layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.P(id='fail_value_f1',  # f"{covid_data_1['recovered'].iloc[-1]:,.0f}"
                   style={
                       'textAlign': 'center',
        ...
        html.Div([
            ...
            html.P(id='fty_value_f1',  # f"{covid_data_1['active'].iloc[-1]:,.0f}"
                   style={
                       'textAlign': 'center',
        ...
        html.Div([
            ...
            html.P(id='dpt_value_f1',  # f"{covid_data_1['active'].iloc[-1]:,.0f}"
                   style={
                       'textAlign': 'center',
    ...
    html.Div([
        ...
        html.Div([
            dcc.Graph(id="Bar2")
                    ], className="create_container six-half columns"),
        ], className="row flex-display"),
                                ])
